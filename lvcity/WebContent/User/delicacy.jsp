		...
		<div class="content clearfix">
			...
			<c:if test="${!empty foodtypelist }">
				<c:forEach items="${foodtypelist}" var="foodtype">
					<li><h3><a target="meishi" href="<%=basePath%>/delicacy/showlist.do?ftid=${foodtype.ftid}&pageNow=1">${foodtype.ft }</a></h3></li>
				</c:forEach>
			</c:if>
         			</ul>
			...
			<iframe id="meishi" name="meishi" src="<%=basePath%>/delicacy/showlist.do?ftid=${firstfoodtypeid}&pageNow=1"  style="float:right;width:712px;height:665px;border:1px solid #cccccc;background-color:white;"></iframe>
